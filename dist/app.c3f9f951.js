...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"node_modules/notiflix/dist/notiflix-aio-3.2.6.min.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
var API_KEY = '39484485-dccfbf14586dc449f78b39dc0';
...
var loadMoreButtonElement = document.getElementById('loadMoreBtn');
var scrollToTopButtonElement = document.getElementById('scrollToTopBtn');
var currentQuery = '';
var currentPage = 1;
...
function _fetchImages() {
  _fetchImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(query) {
    var page,
      queryParams,
      fullUrl,
      response,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          fullUrl = "".concat(BASE_URL, "?").concat(queryParams.toString());
          _context.prev = 3;
          _context.next = 6;
          return _axios.default.get(fullUrl);
        case 6:
          ...
          if (images.length === 0) {
            ...
            renderImages(images);
            currentPage = page;
            successMessage = "Hooray! We found ".concat(totalHits, " images. ") + "Loaded ".concat(images.length, " more. ") + "Total loaded: ".concat(currentPage * PER_PAGE);
            _notiflix.default.Notify.success(successMessage);
            buttonClicked = false;
          }
          _context.next = 16;
          break;
        case 12:
          ...
          _notiflix.default.Notify.failure('Something went wrong. Please try again later.');
        case 16:
        case "end":
...
function renderImages(images) {
  var imageMarkup = images.map(function (image) {
    return "\n    <div class=\"photo-card\">  \n      <a href=\"".concat(image.largeImageURL, "\" data-lightbox=\"gallery\">  \n        <img src=\"").concat(image.webformatURL, "\" alt=\"").concat(image.tags, "\" loading=\"lazy\" />  \n      </a>\n      <div class=\"info\">  \n        <p class=\"info-item\"><b>Likes:</b> ").concat(image.likes, "</p>  \n        <p class=\"info-item\"><b>Views:</b> ").concat(image.views, "</p>  \n        <p class=\"info-item\"><b>Comments:</b> ").concat(image.comments, "</p>  \n        <p class=\"info-item\"><b>Downloads:</b> ").concat(image.downloads, "</p>  \n      </div>\n    </div>\n  ");
  }).join('');
  galleryElement.insertAdjacentHTML('beforeend', imageMarkup);
  // eslint-disable-next-line no-unused-vars
  var lightbox = new _simplelightbox.default('.photo-card a', {});
}
...
loadMoreButtonElement.addEventListener('mouseenter', function () {
  loadMoreButtonElement.style.opacity = '1';
  loadMoreButtonElement.classList.add('bounce');
});
loadMoreButtonElement.addEventListener('mouseleave', function () {
  loadMoreButtonElement.classList.remove('bounce');
});
scrollToTopButtonElement.addEventListener('click', function () {
...
window.addEventListener('scroll', function () {
  var firstImage = galleryElement.querySelector('img');
  ...
  var imagePosition = firstImage.getBoundingClientRect().top;
  ...
  var nearBottom = window.innerHeight + window.scrollY >= document.body.offsetHeight - 10;
  if (nearBottom) {
  ...
  var lastImage = galleryElement.lastElementChild;
  if (lastImage) {
...
},{"axios":"node_modules/axios/index.js","notiflix":"node_modules/notiflix/dist/notiflix-aio-3.2.6.min.js","simplelightbox":"node_modules/simplelightbox/dist/simple-lightbox.modules.js"}],"../../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
